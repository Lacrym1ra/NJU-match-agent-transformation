    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      >
        ...
        <div className="text-center p-6 border-b border-gray-100 flex-shrink-0">
          <h2 className="text-xl font-bold text-[#2C2825]">NJU Date 平台用户协议</h2>
        </div>

        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6 md:p-8 text-sm text-gray-600 leading-relaxed space-y-5 custom-scrollbar">
          <p>欢迎使用 NJU Date（以下简称"本平台"）。本平台是一个面向南京大学在校学生的校园恋爱匹配服务平台。请您在开启配对服务之前，认真阅读并充分理解本协议的所有条款。您勾选"我已阅读并同意"或开启配对即表示您已充分理解并接受本协议的全部内容。</p>
          ...
          <p>本平台承诺：不会向任何第三方出售、出租或共享您的个人信息（法律法规另有规定的除外）。您的数据将采用加密存储，并仅限授权运营人员访问。当您注销账号时，您的问卷数据将被匿名化处理（移除所有可识别字段），配对记录以匿名形式保留用于算法改进。如需完整删除全部数据，请发送邮件至 njumatch@163.com，我们将在 7 个工作日内处理。</p>
          ...
          <p>7.3 账号注销：您可以随时通过「账户设置」页面申请注销账号。注销后，您的问卷数据将被匿名化处理（移除所有可识别字段），配对记录以匿名形式保留用于算法改进，账号将无法恢复。如需完整删除全部数据，请发送邮件至 njumatch@163.com，我们将在 7 个工作日内处理。</p>
